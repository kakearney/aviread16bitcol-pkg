...
%
% This repository includes the code for the |aviread16bitcol.m| Matlab function,
...
% output variables are consistant with those used by Matlab's old aviread
% function. 
% 
%% Getting started
%
% *Prerequisites*
%
% This function requires Matlab R2014a or **earlier**.  It relies on the
% now-deprecated |aviread| function, which has since been replaced by the
% |VideoReader| function.  I no longer work with any AVI files that use
% this old format, so have no plans to update this function to be
% compatible with newer versions of Matlab.
%
% *Downloading and installation*
%
% This code can be downloaded from <https://github.com/kakearney/example-pkg/ Github>
% or the
% <http://www.mathworks.com/matlabcentral/fileexchange/9314-aviread16bitcol
...
%% Description
%
% |mov = aviread16bitcol(filename)| reads the video frame data in the .avi
% file |filename| into a matlab movie matrix |mov|.
%
% |mov = aviread16bitcol(filenameme, index)| reads only the specific frames
% indicated by |index|.
%
%% Contributions
%
...
% <https://github.com/kakearney/aviread16bitcol-pkg/issues an issue> on GitHub and
% include:  
% 
